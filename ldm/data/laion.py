...
def example03():
    # improved aesthetics
    tars = "/SSD/laion2B-en-aesthetic-data/{00000..00063}.tar"
...
def example04():
    # improved aesthetics
    for i_shard in range(64)[::-1]:
        print(i_shard)
        tars = "pipe:aws s3 cp s3://s-laion/laion-2B-en-aesthetics_data/{:06}.tar -".format(i_shard)
        dataset = wds.WebDataset(tars)
